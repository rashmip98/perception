...
if __name__ == "__main__":
    ...
    if args.depth:
        #ep = np.array([-381.82170103, 40.94181718, 1]) #threshmin: 10
        # ep = np.array([-404.87200453, 34.71984383, 1]) #threshmin: 1
        #ep = np.array([-383.6356988, 42.6978295, 1]) #threshmin: 30
