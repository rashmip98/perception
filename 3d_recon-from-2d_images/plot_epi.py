...
def plot_epipolar_lines(image1, image2, uncalibrated_1, uncalibrated_2, E, K, plot=True):
    ...
    epipolar_lines_in_1 = np.linalg.pinv(K).T@E.T@np.linalg.pinv(K)@uncalibrated_2
    epipolar_lines_in_2 = np.linalg.pinv(K).T@E@np.linalg.pinv(K)@uncalibrated_1
        
    #print(uncalibrated_2.shape, uncalibrated_1.shape)
